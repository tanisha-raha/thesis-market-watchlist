...
export function WatchlistTable({ rows, demo = false, conditions = {} }: { rows: WatchlistRow[]; demo?: boolean; conditions?: Record<string, string> }) {
